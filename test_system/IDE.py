...
class MenuTools(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.wait_button.setStyleSheet("QPushButton { text-align: left;}")
        self.waitVanish_button.setStyleSheet("QPushButton { text-align: left;}")
        self.exists_button.setStyleSheet("QPushButton { text-align: left;}")
        self.ocr_button.setStyleSheet("QPushButton { text-align: left;}")
        ...
        self.click_button.setStyleSheet("QPushButton { text-align: left;}")
        self.doubleClick_button.setStyleSheet("QPushButton { text-align: left;}")
        self.rightClick_button.setStyleSheet("QPushButton { text-align: left;}")
        self.swipe_button.setStyleSheet("QPushButton { text-align: left;}")
        self.hover_button.setStyleSheet("QPushButton { text-align: left;}")
        ...
        self.text_button.setStyleSheet("QPushButton { text-align: left;}")
        self.keyevent_button.setStyleSheet("QPushButton { text-align: left;}")
        self.snapshot_button.setStyleSheet("QPushButton { text-align: left;}")
        self.sleep_button.setStyleSheet("QPushButton { text-align: left;}")
        ...
        self.assert_picture_exist_button.setStyleSheet("QPushButton { text-align: left;}")
        self.assert_file_exist_button.setStyleSheet("QPushButton { text-align: left;}")
        self.assert_word_exist_button.setStyleSheet("QPushButton { text-align: left;}")
        self.assert_client_exist_button.setStyleSheet("QPushButton { text-align: left;}")
        self.assert_ocr_true_button.setStyleSheet("QPushButton { text-align: left;}")
        self.assert_recognize_lcd_button.setStyleSheet("QPushButton { text-align: left;}")
